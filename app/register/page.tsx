...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    firstName: "",
    lastName: "",
    role: "ADMIN" as "ADMIN" | "DENTIST" | "RECEPTIONIST",
    phone: "",
    recoverySecret: "", // Palabra secreta para recuperación de cuenta
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Registra un nuevo usuario</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label
                htmlFor="recoverySecret"
                className="block text-sm font-medium text-gray-700 mb-2"
              >
                Palabra Secreta de Recuperación (opcional pero recomendado)
              </label>
              <input
                type="text"
                id="recoverySecret"
                ...
                minLength={6}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                placeholder="Ej: MiClinica2025"
              />
              <p className="mt-1 text-xs text-gray-500">
                🔐 Esta palabra te permitirá recuperar tu cuenta si olvidas tu
                contraseña o email
              </p>
            </div>
